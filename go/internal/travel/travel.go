// Package travel は旅行プランナーの検索の中身。ADK 版と Genkit 版が同じデータを引く。
package travel
...
func SearchSpots(in SearchSpotsInput) SearchSpotsOutput {
...
func SearchRestaurants(in SearchRestaurantsInput) SearchRestaurantsOutput {
...
func SearchTransport(in SearchTransportInput) SearchTransportOutput {
