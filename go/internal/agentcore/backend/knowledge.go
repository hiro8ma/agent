...
var _ agentcore.KnowledgeSearcher = (*InMemoryKnowledge)(nil)

func NewInMemoryKnowledge() *InMemoryKnowledge {
...
func (s *InMemoryKnowledge) Search(_ context.Context, query string, limit int) ([]agentcore.KnowledgeDoc, error) {
	...
	docs := make([]agentcore.KnowledgeDoc, len(results))
