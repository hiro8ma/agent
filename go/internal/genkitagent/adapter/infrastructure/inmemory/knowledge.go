...
var _ externalservice.KnowledgeSearcher = (*Knowledge)(nil)
...
func (s *Knowledge) Search(_ context.Context, query string, limit int) ([]model.KnowledgeDoc, error) {
	...
	docs := make([]model.KnowledgeDoc, len(results))
