...
実行方法:
    adk run samples/agents/travel_planner
    adk run samples/agents/travel_planner "東京から京都に 2 泊 3 日" --jsonl
    uv run python -m samples.agents.travel_planner.live_run
