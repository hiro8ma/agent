...
from samples.agents.weather_agent.agent import root_agent
from samples.agents.weather_agent.tools import (
    _SIGHTSEEING,
    _WEATHER,
    get_sightseeing,
    get_weather,
...
def test_memory_case_declares_prior_state(eval_set: EvalSet) -> None:
    ...
    評価セットの前提不足で落ちる。
    """
    from samples.agents.weather_agent.tools import LAST_CITY_KEY
    ...
    from samples.agents.weather_agent.agent import build_instruction
