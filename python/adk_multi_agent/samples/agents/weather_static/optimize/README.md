...
adk optimize samples/agents/weather_static \
  --sampler_config_file_path samples/agents/weather_static/optimize/sampler.json \
  --optimizer_config_file_path samples/agents/weather_static/optimize/optimizer.json
```
